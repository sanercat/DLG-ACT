...
do
    ...
    # server
    CUDA_VISIBLE_DEVICES=0 python server.py --minfit=10 --mineval=10 --minavl=10 --num_rounds=50 --dataset='HAM10000' --pretrained --train_lr=0.01 --method='iid' --seed=42 --cnt=$j --defense='none' &
    sleep 5
    # clients part 1
    i=1
    while (( i <= 5 ))
    do
        CUDA_VISIBLE_DEVICES=0 python client.py --DevNum=$i --dataset='HAM10000' --pretrained --train_lr=0.01 --n_data=2000 --batch_size=32 --num_sen=64 --num_workers=2 --method='iid' --TotalDevNum=10 --seed=42 --defense='none' --attack='gs' &
