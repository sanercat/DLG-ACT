...
def parse_args():
    ...
    parser.add_argument('--train_lr', default=0.001, type=float)  # 0.001 for cifar10 non-iid, 0.01 for mnist.
    parser.add_argument('--local_epochs', default=1, type=int)
    parser.add_argument('--device_id', default=-1, type=int, help="Device ID for GPU selection, use -1 for CPU")
