...
def get_args_parser():
    ...
    # Dataset
    parser.add_argument('--root', default='/home/lgd/Desktop/SNNFL/datasets', type=str)
    ...
    parser.add_argument('--demo', default=True, action='store_true', help='Run one batch for demo.')
    # Attacks
    parser.add_argument('--attack', default='dlg', type=str, help='dlg, gs, ggl, imprint')
    # dlg and gs attack
    parser.add_argument('--max_iter', default=300, type=int, help='Max iteration for attack.')
    parser.add_argument('--lr', default=0.001, type=float, help='Learning rate for attack.')
    ...
    parser.add_argument('--dcs_iter', default=300, type=int)
