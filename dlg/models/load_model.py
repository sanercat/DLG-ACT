...
from .net import (
    ...
    ConvNet, ConvNet_imp, ConvNet_PRECODE, ConvNet_PRECODE_imp,LeNet,LeNet_CIFAR10,VGGNet16,TinyImageNetConvNet
)
from .resnet import resnet18_imp,resnet152,resnet34,resnet18
    ...
    if args.dataset == 'MNIST':
        ...
        if args.attack == 'imprint':
            ...
            if args.defense == 'precode':
                ...
                model = LeNet_CIFAR10()
                # model = resnet18(pretrained=args.pretrained,num_classes=10)
        ...
        if args.attack == 'imprint':
            ...
            # model = resnet18(pretrained=args.pretrained,num_classes=100)
        ...
        if args.attack == 'imprint':
            ...
            # model = resnet34(pretrained=args.pretrained,num_classes=200)
            model = TinyImageNetConvNet(width=32, num_classes=200, num_channels=3)
        fc = getattr(model, 'fc')
        feature_dim = fc.in_features
